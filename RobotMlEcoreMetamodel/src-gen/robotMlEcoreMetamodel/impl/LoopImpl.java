 ...
 * </p>
 * <ul>
 *   <li>{@link robotMlEcoreMetamodel.impl.LoopImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoopImpl extends ControlStructureImpl implements Loop {
	/**
	...
	protected EClass eStaticClass() {
		return RobotMlEcoreMetamodelPackage.Literals.LOOP;
	}
	...
	public EList<Statement> getBody() {
		if (body == null) {
			body = new EObjectContainmentEList<Statement>(Statement.class, this,
					RobotMlEcoreMetamodelPackage.LOOP__BODY);
		}
		return body;
	}
